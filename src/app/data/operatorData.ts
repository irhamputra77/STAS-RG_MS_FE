...
export interface MahasiswaRecord {
  ...
  tipe: "Riset" | "Magang";
  riset: string[]; bergabung: string;
  pembimbing_lapangan: string; pembimbing_akademik: string;
...
export const mahasiswaData: MahasiswaRecord[] = [
  { id: "M001", nim: "2021012345", name: "Ilham Ramadhan", initials: "IR", color: "bg-[#8B6FFF] text-white", prodi: "S1 Teknik Informatika", angkatan: "2021", email: "ilham.ramadhan@student.ac.id", phone: "0812-3456-7890", status: "Aktif", tipe: "Riset", riset: ["Riset A", "Riset B"], bergabung: "Jan 2025", pembimbing_lapangan: "-", pembimbing_akademik: "Dr. Andi Kurniawan", kehadiran: 18, totalHari: 22, logbookCount: 26, jamMingguIni: 5, jamMingguTarget: 6 },
  { id: "M002", nim: "2021045678", name: "Rizky Pratama", initials: "RP", color: "bg-emerald-500 text-white", prodi: "S2 Informatika", angkatan: "2021", email: "rizky.pratama@student.ac.id", phone: "0813-5678-9012", status: "Aktif", tipe: "Riset", riset: ["Riset A"], bergabung: "Jan 2025", pembimbing_lapangan: "-", pembimbing_akademik: "Dr. Andi Kurniawan", kehadiran: 20, totalHari: 22, logbookCount: 18, jamMingguIni: 6, jamMingguTarget: 6 },
  { id: "M003", nim: "2022034567", name: "Dewi Anjani", initials: "DA", color: "bg-pink-500 text-white", prodi: "S1 Teknik Informatika", angkatan: "2022", email: "dewi.anjani@student.ac.id", phone: "0814-7890-1234", status: "Aktif", tipe: "Riset", riset: ["Riset A"], bergabung: "Mar 2025", pembimbing_lapangan: "-", pembimbing_akademik: "Dr. Andi Kurniawan", kehadiran: 16, totalHari: 22, logbookCount: 12, jamMingguIni: 3, jamMingguTarget: 6 },
  { id: "M004", nim: "2021078901", name: "Fajar Nugroho", initials: "FN", color: "bg-teal-500 text-white", prodi: "S2 Informatika", angkatan: "2021", email: "fajar.nugroho@student.ac.id", phone: "0815-2345-6789", status: "Aktif", tipe: "Magang", riset: ["Riset B"], bergabung: "Mar 2025", pembimbing_lapangan: "-", pembimbing_akademik: "Prof. Budi Santoso", kehadiran: 19, totalHari: 22, logbookCount: 15, jamMingguIni: 43, jamMingguTarget: 45 },
  { id: "M005", nim: "2020056789", name: "Sari Wulandari", initials: "SW", color: "bg-violet-500 text-white", prodi: "S1 Sistem Informasi", angkatan: "2020", email: "sari.wulandari@student.ac.id", phone: "0816-3456-7890", status: "Cuti", tipe: "Magang", riset: ["Riset C"], bergabung: "Jun 2024", pembimbing_lapangan: "-", pembimbing_akademik: "Dr. Hendra Gunawan", kehadiran: 0, totalHari: 22, logbookCount: 5, jamMingguIni: 0, jamMingguTarget: 45 },
  { id: "M006", nim: "2019034521", name: "Bagas Eko Putra", initials: "BE", color: "bg-blue-500 text-white", prodi: "S1 Teknik Informatika", angkatan: "2019", email: "bagas.eko@student.ac.id", phone: "0817-4567-8901", status: "Alumni", tipe: "Riset", riset: ["Riset A"], bergabung: "Jan 2023", pembimbing_lapangan: "-", pembimbing_akademik: "Dr. Sari Dewi", kehadiran: 22, totalHari: 22, logbookCount: 40, jamMingguIni: 0, jamMingguTarget: 6 },
  { id: "M007", nim: "2022098765", name: "Nur Fitria", initials: "NF", color: "bg-rose-500 text-white", prodi: "S1 Teknik Informatika", angkatan: "2022", email: "nur.fitria@student.ac.id", phone: "0818-5678-9012", status: "Aktif", tipe: "Magang", riset: ["Riset B", "Riset C"], bergabung: "Jun 2025", pembimbing_lapangan: "-", pembimbing_akademik: "Prof. Budi Santoso", kehadiran: 17, totalHari: 22, logbookCount: 9, jamMingguIni: 38, jamMingguTarget: 45 },
  { id: "M008", nim: "2021067890", name: "Dimas Aryanto", initials: "DI", color: "bg-amber-500 text-white", prodi: "S2 Informatika", angkatan: "2021", email: "dimas.aryanto@student.ac.id", phone: "0819-6789-0123", status: "Mengundurkan Diri", tipe: "Riset", riset: [], bergabung: "Jan 2025", pembimbing_lapangan: "-", pembimbing_akademik: "Dr. Hendra Gunawan", kehadiran: 3, totalHari: 22, logbookCount: 2, jamMingguIni: 0, jamMingguTarget: 6 },
];
